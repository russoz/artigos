...
Processador que utiliza o módulo L<Data::Dumper> para imprimir a estrutura de cada item
para STDERR.
...
Processador "NO-OP". A informação sai do mesmo jeito que entrou. Pode ser utilizado como
...
Processador que recebe URLs na entrada, e retorna o conteúdo das mesmas na saída.
...
Por exemplo, o trecho de script abaixo (baseado no script
L<ceis.pl|XXXXXXXXXXXXXXXXXXXXXXXXX>), obtém as informações das
