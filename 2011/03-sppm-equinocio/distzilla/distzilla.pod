...
corresponde aos I<plugins>: GatherDir, PruneCruft, ManifestSkip, MetaYAML,
License, Readme, ExtraTests, ExecDir, ShareDir, MakeMaker, Manifest,
...
=head4 Exemplo Comentado

Vamos colar aqui o C<dist.ini> atual do projeto L<Queue::Base> e comentar
cada trecho.

B<Informações básicas do projeto>. Particularmente, o número da versão poderia
também ser automatizado, e será algum dia. Essas informações podem depois ser
utilizadas para gerar documentação POD automaticamente.
