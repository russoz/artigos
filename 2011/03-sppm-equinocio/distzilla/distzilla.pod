...
Notem nesse trecho comentado do 
...
Todos esses nomes de seções (com exceção dos que começam com "@" e de algumas
seções que contém uma barra "/"), correspondem a classes no I<namespace>
C<Dist::Zilla::Plugins::>, isto é, no trecho acima estamos referenciando as
classes:

=over

=item *
L<Dist::Zilla::Plugins::GatherDir>

=item *
L<Dist::Zilla::Plugins::MetaYAML>

=item *
L<Dist::Zilla::Plugins::ModuleInstall>

=item *
L<Dist::Zilla::Plugins::Manifest>
