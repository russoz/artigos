...
[1] PAUSE - The [Perl programming] Authors Upload Server
...
=item *
B<Ricardo Signes (RJBS)>, pelo Dist::Zilla. Quando comecei a converter o
processo de I<build> do Queue::Base para Dist::Zilla, entrei no canal 
#distzilla do irc.perl.org e comentei o fato. Ele foi um dos primeiros a
responder, se interessar e se colocar à disposição.

=item *
B<Comunidade São Paulo Perl Mongers>, pelo companheirismo, pelas infinitas
risadas, pela dedicação com que todos zelam pela nossa lingaugem de programação
predileta.
