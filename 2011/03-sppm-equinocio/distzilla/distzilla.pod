...
O B<git> viabilizou serviços como o L<github|http://github.com>[5], um serviço 
público de
hospedagem de repositórios B<git>, onde pode-se manter repositórios
gratuitamente.
...
L<< primeiro C<dist.ini> do Queue::Base | https://github.com/russoz/Queue-Base/blob/3702c381595c0dfa6e7644bd945987b95af2e20c/dist.ini >>[14], que colocamos uma
seção do C<dist.ini> na qual especificamos o uso do L<Module::Install>[15].
...
não faz parte do próprio Dist::Zilla, ele foi desenvolvido por
...
L<< infinidade de diferentes tarefas | http://search.cpan.org/search?query=Dist::Zilla::Plugin&mode=all >>[21]. Destacamos aqui alguns mais importantes:
...
O Dist::Zilla é uma fantástica ferramenta de auxílio ao desenvolvedor.
Ela facilita o processo de desenvolvimento, testes, I<release>, e até mesmo
o de documentar seu código. E o melhor é que você não precisa jogar fora 
B<tudo> o que tem pronto para começar a usá-lo: a conversão pode ser feita
de forma gradual.
