...
O racional de um C<Node> é o mesmo de um comando de Unix ou Linux que atua
como um filtro: ele é um pedaço de cano (I<pipe>), que faz uma coisa só,
...
Thiago "Maluco" Rondon C<< < thiago em aware ponto com ponto br > >>
