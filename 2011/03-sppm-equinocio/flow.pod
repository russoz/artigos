...
Tipo especial de nó, que possui uma lista de nós, e concatena esses nós, de
modo que os dados produzidos na saída de um nó são automaticamente injetados
no próximo nó. Como um objeto da classe L<DataFlow::Chain> é também da classe
L<DataFlow::Node>, ele também pode ser parte de uma outra cadeia de nós.
...
fila de entrada do nó. Como ele não modifica o valor, essa mesma URL é o
