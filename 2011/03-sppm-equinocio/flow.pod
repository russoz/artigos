...
* Execução em paralelo (com threads e com fork)

* Nó para leitura/escrita de arquivos

* Nó para I<encoding> de caracteres
...
* Nó para executar comandos externos
...
* Nós que permitam I<split> e I<join> de fluxos de informação
