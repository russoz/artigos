...
B<PEGADINHA>: nesta última forma, os elementos do ArrayRef NÃO serão
transformados você pode ter um node que espera de fato uma ref e trata a
mesma de acordo com suas próprias regras. O mesmo se aplica a outros tipos
